...
class M2(Player): # 2 moves history of opp
	...
	def procreate(self,sp):

		kid = M2(self.total_turns,sp)
		return kid
...
class M2_2(Player): # My last ove. opp last move
	def __init__(self,total_turns,strategy_params):
		Player.__init__(self,total_turns)
		self.starting_move='C'
		self.strategy_params=strategy_params
...
class Mp(Player): # Varianc of Mutation
	...
	def procreate(self,sp):
		...
		kid = Mp(self.total_turns,sp,self.var)
		return kid
...
class Md2(Player): # my disc value, opp discount value
	...
	def procreate(self,sp):
		...
		kid = Md2(self.total_turns,sp,self.discount)
		return kid
...
class Md1(Player): # my disc value, opp discount value
	...
	def procreate(self,sp):
		...
		kid = Md1(self.total_turns,sp,self.discount)
		return kid
