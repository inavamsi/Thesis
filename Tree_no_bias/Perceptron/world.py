...
def diff_memory_types():
	...
	for i in range(100):
		...
		#pop.append(Memory_strategy.Mperp(100,0.1,2,0,[2],consumption_per))
		pop.append(Memory_strategy.Mperp(100,0.1,0,1,[],consumption_per))
		pop.append(Memory_strategy.Mperp(100,0.1,0,2,[],consumption_per))
		pop.append(Memory_strategy.Mperp(100,0.1,0,2,[2],consumption_per))
		...
		#pop.append(Memory_strategy.Mperp(100,0.1,0,2,[2,2],consumption_per))
		#pop.append(Memory_strategy.Mperp(100,0.1,0,3,[2,2],consumption_per))
		#pop.append(Memory_strategy.Mperp(100,0.1,3,0,[2,2],consumption_per))
		#pop.append(Memory_strategy.Mperp(100,0.1,2,0,[2],consumption_per))
		#pop.append(Memory_strategy.Mperp(100,0.1,2,1,[2],consumption_per))
	...
	mut_type='all'
	#mut_type='one'
	world(10,200,"types",total_res,ptypes,mut_type,game_para,total_turns,pop)
