...
def diff_memory_types():
	...
	for i in range(15):
		#pop.append(Memory_strategy.Mperp(100,0.1,0,1,[2]))
		#pop.append(Memory_strategy.Mperp(100,0.1,0,2,[2]))
		pop.append(Memory_strategy.Mperp(100,0.1,0,3,[2]))
		pop.append(Memory_strategy.Mperp(100,0.1,0,4,[2]))
		pop.append(Memory_strategy.Mperp(100,0.1,0,5,[2]))
		pop.append(Memory_strategy.Mperp(100,0.1,0,6,[2]))
